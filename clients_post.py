...
RUBRIC_ANCHOR = {
    ...
    "results": (
        ...
        "рабочий кейс по схеме: задача клиента — что я сделала — чем "
        "закончилось. Без сумм, сроков, процентов и имён."
    ),
    "inspiration": (
        "Это рубрика про эмоцию и уют. Пост ОБЯЗАН опираться на ощущение от "
        "пространства или на спокойствие от порядка в делах. Инструкций, "
        "чек-листов и разборов документов здесь быть не должно."
    ),
    "observation": (
...
RUBRIC_FORMATS = {
    ...
    "results": [
        ...
        {"scene": False, "text": "Формат «что стояло на кону». Начни с того, что было важно для клиента, затем — что я сделала, чтобы это сохранить. 90–130 слов."},
        {"scene": False, "text": "Формат «нетипичный запрос». Опиши необычное требование к объекту или к полису и как я его закрыла. 90–130 слов."},
        {"scene": False, "text": "Формат «что удалось предотвратить». Расскажи, какую проблему нашли до сделки и чем это помогло. 90–130 слов."},
        {"scene": True, "text": "Формат «короткий кейс из практики». Одна сделка от обращения до завершения, спокойно и по фактам. 90–130 слов."},
    ],
    "inspiration": [
        {"scene": False, "text": "Формат «атмосфера». Начни с описания света, звука или ощущения в пространстве, затем свяжи это с выбором жилья. 80–120 слов."},
        {"scene": False, "text": "Формат «маленькая деталь». Возьми одну деталь квартиры (окно, кухня, вид, планировка) и объясни, как она меняет жизнь. 80–120 слов."},
        {"scene": False, "text": "Формат «размышление». Спокойная мысль о доме, спокойствии и безопасности, без инструкций. 70–110 слов."},
        {"scene": False, "text": "Формат «сравнение настроений». Покажи контраст: как ощущается пространство до и после того, как оно становится своим. 80–120 слов."},
        {"scene": True, "text": "Формат «момент из работы». Опиши, как клиент понял, что нашёл своё жильё. Тепло, без пафоса. 80–120 слов."},
    ],
    "observation": [
        {"scene": False, "text": "Формат «закономерность». Начни с вывода, который я сделала за годы работы, затем объясни, из чего он складывается. 90–130 слов."},
        ...
        {"scene": True, "text": "Формат «наблюдение с объекта». Одна конкретная деталь, замеченная в работе, и общий вывод из неё. 90–130 слов."},
    ],
    "tips": [
